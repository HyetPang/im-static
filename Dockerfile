...
WORKDIR /go/src/app
COPY . .
RUN  git config --global url."git@github.com:".insteadOf "https://github.com/" && git config --global http.extraheader PRIVATE-TOKEN:b4486da5cf22d0b71046d25d194b31be839d830f && go build -o im-static main.go
