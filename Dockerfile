...
WORKDIR /go/src/app
COPY . .
RUN  git config --global url."https://b4486da5cf22d0b71046d25d194b31be839d830f:x-oauth-basic@github.com/zengyu2020".insteadOf "https://github.com/zengyu2020" && go build -o im-static main.go
